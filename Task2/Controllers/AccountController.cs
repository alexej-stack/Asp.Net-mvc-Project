...
namespace Task2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Edit()
        {
            ...
            if (user != null)
            {
                AspNetUser model = new AspNetUser {Id = user.Id };
                return View(model);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //  result = await UserManager.CreateAsync(user.Id, model.RoleName);
        ...
        public void SendVerificationLinkEmail(string emailID, string activationCode)
        {
            ...
            var fromEmail = new MailAddress("alexejdrosdov@gmail.com", "xddd");
            var toEmail = new MailAddress(emailID);
            var fromEmailPassword = "alexejdrosdov"; // Replace with actual password
